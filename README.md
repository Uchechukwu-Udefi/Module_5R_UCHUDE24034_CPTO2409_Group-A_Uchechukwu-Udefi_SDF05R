...
- Button 2 is style to have white background, black color and border. On hover, displays glowing party color shadow on infinite animation, black border and blue color.
